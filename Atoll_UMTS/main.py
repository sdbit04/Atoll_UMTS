...
dir_name1 = os.path.dirname(dir_name)
sys.path.append(dir_name1)
from Atoll_UMTS.antennas_xml_update import AtollXmlConverter
...
if __name__ == "__main__":
    ...
    AtollXmlConverter.copy_required_files(xml_dir_in, xml_dir_out)
